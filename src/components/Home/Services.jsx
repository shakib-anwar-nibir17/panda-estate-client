const Services = () => {
  return (
    <div
      className="px-3 md:lg:xl:px-40 my-20 border-t border-b py-20 bg-custom-red-400"
      style={{
        backgroundImage:
      ...
      <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
        <div className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-red-50 cursor-pointer">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Agents of Panda Estate will dedicate to find the perfect home for
            you
          </p>
        </div>
        ...
        <div className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Each of our properties have been thoroughly checked making them the
            safest choice you can make
          </p>
        </div>
        ...
        <div className="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
          ...
          <p className="mt-2 text-sm text-slate-500">
            We ensure the best support you will ever get to find your perfect
            home
          </p>
        </div>
        ...
        <div className="p-10 flex flex-col items-center text-center group    md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
          ...
          <p className="mt-2 text-sm text-slate-500">
            We offer thousand of properties based on different desires. We have
        ...
        <div className="p-10 flex flex-col items-center text-center group     hover:bg-slate-50 cursor-pointer">
          ...
          <p className="mt-2 text-sm text-slate-500">
            We believe in trust. Your most trusted partner to find your dream
            home
          </p>
        </div>
      </div>

      <div className="w-full   bg-custom-red-400 shadow-xl shadow-red-200 py-10 px-20 flex justify-between items-center">
        <p className=" text-white">
          {" "}
          <span className="text-4xl font-medium">
            Still Confused ?
          </span> <br />{" "}
          <span className="text-lg">Book For Free Consultation Today ! </span>
        </p>
        <button className="px-5 py-3  font-medium text-white shadow-xl  hover:bg-custom-red-500 duration-150  bg-custom-main">
          BOOK AN APPOINTMENT{" "}
        </button>
      </div>
    </div>
